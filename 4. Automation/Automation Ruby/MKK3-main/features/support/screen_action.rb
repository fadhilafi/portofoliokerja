...
def Confirm_Form1()
    %driver.find_element(:xpath, '//*[@id="__BVID__36___BV_modal_body_"]/div/div[2]/div/div/div[2]/button').click
    sleep(5)
end

def Agree_Button()
    $driver.find_element(:xpath, '//*[@id="requestOtp___BV_modal_body_"]/div[2]/div/div[2]/button').click
    sleep(10)
end    
