def Form1_Screen()
    title2 = %driver.find_element(:xpath, '//div[@class="animated fadeIn"]/div/div[2]/div/div[2]/div/p').text
    if title2 = "Data Pribadi"
...
def Self_Pic()
    %driver.find_element(:xpath, '//div[@class="wizard-tab-content"]/div[1]/div/fieldset[6]/div/div/label/div[2]').click
    sleep(5)
    Capture_Pic2()
end
...
def Npwp_Pic()
    %driver.find_element(:xpath, '//div[@class="wizard-tab-content"]/div[1]/div/fieldset[14]/div/div/label/div[2]').click
    sleep(5)
    Capture_Pic2()
end
