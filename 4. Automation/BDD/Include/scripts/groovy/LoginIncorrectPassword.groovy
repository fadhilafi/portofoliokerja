...
class LoginIncorrectPassword {
	...
	public void user_enter_username_binarqae_gmail_com_and_password_students(String username, String password) {
	...
	public void user_is_showed_wrong_password_pop_up_message() {
		WebUI.closeBrowser()
	}
}