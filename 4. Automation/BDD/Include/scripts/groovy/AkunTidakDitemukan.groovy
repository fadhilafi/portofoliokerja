...
class AkunTidakDitemukan {
	...
	public void user_enters_username_binarqa_gmail_com_and_password_students(String username, String password) {
	...
	@Then("Users is showed wrong Akun Tidak Ditemukan pop up message")
	public void users_is_showed_wrong_Akun_Tidak_Ditemukan_pop_up_message() {
		WebUI.closeBrowser()
	}
}